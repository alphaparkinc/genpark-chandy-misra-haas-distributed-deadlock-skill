# genpark-chandy-misra-haas-distributed-deadlock-skill

[![Agentic Skill](https://img.shields.io/badge/GenPark-Agentic__Skill-blue.svg)](https://github.com/alphaparkinc/genpark-chandy-misra-haas-distributed-deadlock-skill)
...
> Chandy-Misra-Haas probe-based edge-chasing algorithm detecting distributed wait-for dependency deadlocks across asynchronous agent swarms.
...
flowchart TD
    ...
    B --> C[genpark-chandy-misra-haas-distributed-deadlock-skill Core Engine]
